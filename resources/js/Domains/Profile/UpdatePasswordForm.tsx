    ...
    >
      <div className="col-span-6 sm:col-span-4">
        ...
        <JetInput
          ...
          onChange={e => {
            ...
            if (
              ...
              form.data.password.length <= 30
            ) {
              setErrorDos(
                reportarError(form.data.password, e.currentTarget.value, 2),
              );
            }
        ...
        <p className="absolute text-sm text-red-600 mt-2 mb-0">{`${
          form.errors.current_password == undefined
            ? errorUno
      ...
      <div className="col-span-6 sm:col-span-4 mt-2">
        ...
        <JetInput
          ...
          onChange={e => {
            ...
            if (
              e.currentTarget.value.length > 0 &&
              form.data.current_password.length == 0
            ) {
              setErrorUno('Este campo es obligatorio');
            ...
            form.data.password_confirmation.length > 0
              ? e.currentTarget.value === form.data.password_confirmation
                ? setErrorTres('')
                : setErrorTres(
                    'La confirmación no es igual a la nueva contraseña',
                  )
              : setErrorTres('');
            if (
              e.currentTarget.value.length == 0 &&
      ...
      <div className="col-span-6 sm:col-span-4 mt-2">
        ...
        <JetInput
          ...
          onChange={e => {
            ...
            form.data.password.length > 0
              ? e.currentTarget.value === form.data.password
                ? setErrorTres('')
                : setErrorTres(
                    'La confirmación no es igual a la nueva contraseña',
                  )
